    ...
    if(CGRectGetMaxY(self.giftShowView1.frame) < CGRectGetMaxY(self.giftShowView2.frame)) { //giftShowView1高
        ...
        if(topCount < bottomCount) { //底部count大 顶部frame.y高
            [UIView animateWithDuration:0.3 animations:^{
                self.giftShowView1.frame = CGRectMake(0, 150, 200, 50);
        ...
        if(topCount < bottomCount) { //底部count大 顶部frame.y高
            [UIView animateWithDuration:0.3 animations:^{
                self.giftShowView1.frame = CGRectMake(0, 100, 200, 50);
                self.giftShowView2.frame = CGRectMake(0, 150, 200, 50);
                //不是实际交换位置 会导致重叠
...
- (LDSGiftShowView *)giftShowView1 {
    if (_giftShowView1 == nil) {
        _giftShowView1 = [[LDSGiftShowView alloc] initWithFrame:CGRectMake(-200, 100, 200, 50)];
        __weak typeof(self) weakSelf = self;
...
- (LDSGiftShowView *)giftShowView2 {
    if (_giftShowView2 == nil) {
        _giftShowView2 = [[LDSGiftShowView alloc] initWithFrame:CGRectMake(-200, 150, 200, 50)];
        __weak typeof(self) weakSelf = self;
